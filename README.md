...
![Python](https://img.shields.io/badge/Python-orange?style=flat-square&logo=python&logoColor=white)
...
- **Projects:** Writing custom Roblox scripts in Lua
  for Riftworksstudios

### 2020-present: Enterprise-specific Discord Bots

- **Details:** Development of license systems and cross-functional systems
- **Certification:** Verified Bot Developer by Discord since 2025
- **Projects:**
  ...
  - **Major Project:** A gambling bot that successfully engages over 7.800 users, demonstrating significant impact and reach within the community
